...
co2_nc['total_population'] = co2_nc['Total Population - Female'] + co2_nc['Total Population - Male']


# transpose gdp data to make it mergable to co2_n
gdp_n= gdp_north.T.reset_index()
gdp_n.columns = ['Year','Canada_GDP','Guatemala_GDP','Mexico_GDP','United States_GDP']
...
agro_gdp = pd.merge(co2_nc,gdp_nrc,how='inner',left_on='Year',right_on='Year')
